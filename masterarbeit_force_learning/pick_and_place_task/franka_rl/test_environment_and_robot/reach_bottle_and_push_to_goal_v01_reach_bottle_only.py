...
class PandaPushEnv(gym.Env):
    ...
    def _compute_reach_target(self):
        ...
        # reach_target[1] = bottle_pos[1] + 0.12  # 12cm behind bottle
    ...
    def _get_reward(self):
        ...
        if not self.pushing_phase:
            ...
            proximity_gate = np.exp(-3.0 * hand_to_target_distance_3d)
            ...
            reached_position = hand_to_target_distance_3d < 0.08
            reached_with_orientation = hand_to_target_distance_3d < 0.05 and quat_error < 0.1
            ...
            if self.episode_length % 50 == 0:
                print(f"\n Target position: [{reach_target[0]:.3f}, {reach_target[1]:.3f}, {reach_target[2]:.3f}]")
                print(f"\n Hand Position: [{hand_pos[0]:.3f}, {hand_pos[1]:.3f}, {hand_pos[2]:.3f}]")
            ...
            target_to_bottle_distance = np.linalg.norm(bottle_pos - self.reach_target)
            ...
            """
            # pass
            print("This is test and at least the pushing phase is being activated!")
