...
MODEL_DIR = f"trained_model_{TRAJECTORY_TYPE}_only_push_v25" # <--- Change to v26, v27, etc. in the future

NUM_EPISODES = 10
VISUAL_DELAY = 0 # was 0.02  # Seconds between frames (0 for max speed)
